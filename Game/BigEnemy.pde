class BigEnemy extends Enemy {
  ...
  public BigEnemy() {
    ...
    this.base = base;
    sprite = new PImage[2];
    sprite[0] = loadImage("Sprites/Grey_Matters_Big_enemy_Part1.png");
    sprite[1] = loadImage("Sprites/Grey_Matters_Big_enemy_Part2.png");
    this.pos = new PVector(1280.0, random(960));
    this.oldPosX = pos.x;
    this.oldPosY = pos.y;
    this.rotation = atan2(oldPosY - base.getPosY(), oldPosX - base.getPosX()) / PI * 180;
    this.speed = -1; // speed is negative since the enemies move "backwards" on the X-axis
    size = 60.0;
    this.isDead = false;
    decals = new PImage[3];
    health = 1;
